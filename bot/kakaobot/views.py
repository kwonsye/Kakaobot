...
def keyboard(request):
	return JsonResponse({
		'type':'buttons',
		'buttons':['가정폭력','성폭력','여성폭력 피해자 지원정책','피해자분들에게 전하고 싶은 따뜻한 한 마디','당신에게 드리는 따뜻한 한 마디','신고 및 긴급상담 번호','개발자에게 피드백하기']
})
...
def message(request):
	...
	if content=='개발자에게 피드백하기':
		return JsonResponse({
			'message':{
				'text':'1.개발자에게 개선사항_이메일 보내기\n2.개발자에게 버그신고_이메일 보내기\n*원하는 항목을 선택하세요.'
},
			'keyboard':{
			'type':'buttons',
			'buttons':['개발자에게 개선사항_이메일 보내기','개발자에게 버그신고_이메일 보내기','처음으로']

}
})
	elif content=='개발자에게 개선사항_이메일 보내기':
		return JsonResponse({
			'message':{
				'text':'안녕하세요. 가정폭력 성폭력 챗봇을 개발한 학생입니다. 저의 챗봇이 사용자분께 작은 도움이 될 수 있기를 바랍니다.\n개선할 사항 및 피드백을 자유롭게 보내주세요^_^ 최대한 빠르게 개선하도록 노력하겠습니다!\n*이메일은 당연히 익명으로 보내지며, 하단 [이메일 형식]에 맞게 내용을 작성하신 후 채팅방에 메세지를 보내시면 저에게 바로 이메일이 보내진답니다!\n\n[이메일 형식]: 개선사항_"이 부분에 내용을 작성해주세요.(큰따옴표는 안쓰셔도 됩니다.)"\n\n*초기항목으로 돌아가시려면 [처음으로]를 입력해주세요. [ ]는안쓰셔도 됩니다.'
},
			'keyboard':{
				'type':'text'
}
	...
	elif content=='개발자에게 버그신고_이메일 보내기':
		return JsonResponse({
			'message':{
				'text':'안녕하세요. 가정폭력 성폭력 챗봇을 개발한 학생입니다.챗봇을 사용하면서 불편함을 느끼게 해드려 죄송합니다.\n어떤 부분에서 버그(오류)가 발생하는지 편하게 알려주세요^_^ 최대한 빠르게 해결하도록 노력하겠습니다!\n*이메일은 당연히 익명으로 보내지며, 하단 [이메일 형식]에 맞게 내용을 작성하신 후 채팅방에 메세지를 보내시면 저에게 바로 이메일이 보내진답니다!\n\n[이메일 형식]: 버그신고_"이 부분에 내용을 작성해주세요.(큰따옴표는 안쓰셔도 됩니다.)"\n\n*초기항목으로 돌아가시려면 [처음으로]를 입력해주세요. [ ]는안쓰셔도 됩니다.'
},
			'keyboard':{
				'type':'text'
}
	...
	elif content.startswith('버그신고_'):
		email_content=content[5:]
		result=send_email_bug(email_content)
		if result == True:
			msg = "개발자에게 성공적으로 이메일을 보냈습니다.피드백 감사합니다!"
		elif result == False:
			msg = "오류가 생겨 이메일을 보내지 못했습니다. 잠시후 다시 시도해주세요."
		return JsonResponse({
			'message':{
				'text':msg
},                	'keyboard':{
	...
	elif content.startswith('개선사항_'):
		email_content=content[5:]
		result=send_email_feedback(email_content)
		if result == True:
			msg = "개발자에게 성공적으로 이메일을 보냈습니다.피드백 감사합니다!"
		elif result == False:
			msg = "오류가 생겨 이메일을 보내지 못했습니다. 잠시후 다시 시도해주세요."
